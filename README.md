...
- [ ] Ошибка: при завершении турнира в попапе отобразилось не то имя (результат турнира был корректный)

### Приоритетно, в очереди
- [ ] Счетчик оставшихся матчей (полускрытый)

### Прочие идеи по развитию
- [ ] Отдельная страница с итоговыми победителями обоих турниров
- [ ] Настройка турнира перед запуском (переигрывается ли финал, разрешено ли смотреть турнирную таблицу)
...
- [x] Страница результатов по местам участников
